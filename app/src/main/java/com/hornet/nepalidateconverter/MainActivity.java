...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, DatePickerDialog.OnDateSetListener,TimePickerDialog.OnTimeSetListener {
    ...
    Button adToBs, bsToAd, datePicker,timePicker,save,view;
...
//        timePicker.setOnClickListener(this);
        view=(Button)findViewById(R.id.schedule);
...
public void viewdata(){
    ...
    ArrayList<notesgetter> notesgetterArrayList =new ArrayList<>();
}
...
//    }
    ...
    public void onDateSet(DatePickerDialog view, int year, int monthOfYear, int dayOfMonth) {
        date =  dayOfMonth + " " + getResources().getString( DateConverter.getNepaliMonth(monthOfYear)) + " " + year;
